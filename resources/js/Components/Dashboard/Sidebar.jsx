        ...
        <aside className="sidenav bg-default navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
            <div className="sidenav-header">
                ...
                <Link className="navbar-brand m-0" href={route('home')} target="_blank">
                    ...
                    <span className="ms-1 font-weight-bold"> Panel de Control</span>
                </Link>
            </div>
                ...
                <ul className="navbar-nav">
                    <li className="nav-item">
                        <Link className={`${route().current('dashboard') && 'active'} nav-link`} href={route('dashboard')}>
                            ...
                            <span className="nav-link-text ms-1">Publicaciones</span>
                        </Link>
                    </li>
                    <li className="nav-item mt-3">
                        <h6 className="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Configuración</h6>
                    </li>
                    <li className="nav-item">
                    ...
                    <li className="nav-item">
                        <Link className={`${route().current('users.*') && 'active'} nav-link`} href={route('pets.index')}>
                            <div className="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                                <img src="/img/huella.png" alt="Imagen" className="img-fluid" />
                            </div>
                            <span className="nav-link-text ms-1">Mascotas</span>
                        </Link>
                    </li>
                    <li className="nav-item">
