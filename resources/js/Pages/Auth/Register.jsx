        ...
        <>
            <div>
                <main className="main-content  mt-0">
                    <div className="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style={{backgroundImage: 'url("/img/petchainv2.png")', backgroundPosition: 'cover'}}>
                        ...
                        <div className="card z-index-0">
                            ...
                            <div className="col-12 px-1 inline-block">
                                <a className="btn btn-outline-light w-100 inline-block" href={route('auth.google')} >
                                    ...
                                    &nbsp;&nbsp;
                                    <span className='fw-bold text-dark'>Registrate con Google</span>
                                </a>
                            </div>
                            ...
                            <form role="form" onSubmit={submitHandler}>
                                ...
                                <p className="text-sm mt-3 mb-0 text-center">
                                    ...
                                    <Link href={route('login')} className="text-dark font-weight-bolder">Inicia Sesión</Link>
                                </p>
                            </form>
                            </div>
                        </div>
                ...
                <footer className="footer py-5">
                    ...
                    <div className="row">
                        ...
                        <p className="mb-0 text-secondary">
                            Copyright ©  Soft by PetChain Team.
                        </p>
                        </div>
                    </div>
                    </div>
