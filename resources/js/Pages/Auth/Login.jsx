            ...
            <div className="page-header min-vh-100">
                <div className="container">
                    <div className="row">
                                ...
                                <div className="card z-index-0">
                                    ...
                                    <div className="card-body">
                                        <form role="form" onSubmit={submitHandler} noValidate>
                                            ...
                                            <div className="text-center">
                                                <button type="submit" className="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">Inicia Sesión</button>
                                            </div>
                                        </form>
                                    </div>
                                    <div className="card-footer text-center pt-0 px-lg-2 px-1">
                                        <p className="mb-4 text-sm mx-auto">
                                            ...
                                            <Link href={route('register')} className="text-primary text-gradient font-weight-bold">Registrate</Link>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden" style={{backgroundImage: 'url("/img/petchainv2.png")', backgroundSize: 'cover'}}>
                            <span className="mask bg-gradient-primary opacity-6" />
                            <h4 className="mt-5 text-white font-weight-bolder position-relative">"¿Alguna vez perdiste tu mascota?"</h4>
                            <p className="text-white position-relative">Solo debes registrarlo.</p>
                        </div>
                        </div>
                    </div>
                </div>
